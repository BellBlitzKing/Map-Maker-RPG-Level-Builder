    ...
    const getHtml = (width, height) =>{
      ...
      <div class="card_body">
        ...
        <div style="min-width: 322px; width: fit-content; height: fit-content; text-align: center; display: block; padding-top: 7px; background: #28423af0;"  class="select_container layer sticky_top sticky_left"  id="mapSelectContainer" style="margin-bottom: 5px">
         ...
         <select title="Pick a Map from the list ☰" style="margin-top: 5px; border-radius: 4px; outline: 2px solid dodgerblue; background-color: LightGoldenrodYellow; height: 22px; width: 135px; cursor: pointer; font-size: medium; margin-bottom: 12px;" name="mapsData" id="mapsDataSel"></select>
			<button style="width: 32px; height: 21px; margin: 2px; border-radius: 3px; font-size: small; cursor: pointer; margin-right: 5px; margin-left: 5px; " id="renameMapBtn" title="📝 Rename this Map ✍️">✍️</button>
...
<div style="margin-top: 8px; justify-content: center; display: flex;" id="fileMenuDropDown">
</div>
...
Grid <input style="font-size: small;" title="⊞ Grid On or Off ⌗" value="true" checked="checked" type="checkbox" id="showGrid" checked></input>
                ...
                <div style="cursor: default; margin-top: 8px; margin-bottom: -2px; padding-bottom: 20px;" id="tileGroupButtons">
				  ...
				  <button title="🍄 Flower & Land Tiles 🟩" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 576, behavior: 'smooth'});">🍄</button>
                  
                  <button title="🪧 Signs & Unique Objects 🗡️" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 992, behavior: 'smooth'});">🪧</button>
                  <button title="🧝 Character Tiles 🧙‍♂️" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 1184, behavior: 'smooth'});">🧙‍♂️</button>
                  
				  <button title="📦 Boxes and House Objects🪑" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 1920, behavior: 'smooth'});">📦</button>
                  <button title="⛩️ Fences & Gate Tiles 🚧" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 2304, behavior: 'smooth'});">⛩️</button>
                  <br>

                  <button title="🏛️ Brick Structures 🏗️" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 2848, behavior: 'smooth'});">🏛️</button>

                  <button title="🏠 Homes + Buildings 🏡" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 3808, behavior: 'smooth'});">🏠</button>
                  <button title="🎪 Shops + Booths 🛖" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 5920, behavior: 'smooth'});">🎪</button>
                  <button title="🎡 Windmills 🏭" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 7584, behavior: 'smooth'});">🎡</button>
                  <button title="🗼 Lighthouse Towers 🏗️" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 8064, behavior: 'smooth'});">🗼</button>
                  
				  <button title="🏰 Brick Towers 🧱" style="padding: 2px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 9344, behavior: 'smooth'});">🏰</button>
				  <button title="🆎 Letters + Alphabet 🔠" style="padding: 2px; margin-bottom: 10px; font-size: large; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 9920, behavior: 'smooth'});">🆎</button>
					<br>

                  <button title="🌴 Forest Tiles 🍃" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 10368, behavior: 'smooth'});">🌴</button>
                  <button title="🌊 River Tiles 🏞️" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 10784, behavior: 'smooth'});">🌊</button>
                  <button title="🏜️ Desert Tiles 🌵" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 11072, behavior: 'smooth'});">🏜️</button>
                  <button title="🧊 Winter Tiles ❄️" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 11776, behavior: 'smooth'});">🧊</button>
                  
                  <button title="🌸 Dreamland Tiles 🦄" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 12512, behavior: 'smooth'});">🌸</button>
                  <button title="🐸 Swampland Tiles 🐊" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 13216, behavior: 'smooth'});">🐸</button>
                  <button title="🔥 Fireland Tiles 🌋" style="padding: 2px; font-size: larger; cursor: pointer; border-color: transparent; border-radius: 3px;" onclick="document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: 13920, behavior: 'smooth'});">🔥</button>
