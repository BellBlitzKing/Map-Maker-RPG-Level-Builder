 ...
 <!-- Tab links added -->
                        ...
                        <div class="tab-container">
                          <div style="background: linear-gradient(to bottom, #28423a 94%, aliceblue 94%);" class="tabs">
							...
							class="tab active" data-tab="home" id="myTiles">Tilex 📚</button>
							...
							class="tab" data-tab="about" id="myMaps">Mapx 🌄</button>
                          </div>
...
<!--                <button id="removeTileAnimBtn" title="remove animation">-</button>-->
      ...
      <div style="border-radius: 6px;" id="mapholder" class="tileset-container">
        ...
        <canvas onclick="new Audio('https://bellblitzking.github.io/Map-Maker-RPG-Level-Builder/sounds/GenericClick_2_Fade.wav').play()" style="border-radius: 6px;" id="tilesetCanvas" />
...
<button style="text-align: center; cursor: pointer; margin-top: 10px; margin-bottom: 15px; color: gold; height: 26px; border-radius: 6px; width: 128px; font-size: 14px;"><label style="cursor: pointer;" for="tool2" title="↔️ move and scroll around the map ⊞" data-value="2"><small>◀  </small>Move Map<small>  ▶</small></label></button>
