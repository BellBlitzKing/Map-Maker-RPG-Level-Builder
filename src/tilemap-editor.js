...
<!--        <div id="tilesetGridContainer" class="tileset_grid_container"></div>-->
                          ...
                          <div class="tab-content" id="about">
                            ...
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 1" onclick="document.getElementById('mapsDataSel').value='1'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 2" onclick="document.getElementById('mapsDataSel').value='2'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 3" onclick="document.getElementById('mapsDataSel').value='3'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 4" onclick="document.getElementById('mapsDataSel').value='4'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 5" onclick="document.getElementById('mapsDataSel').value='5'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 6" onclick="document.getElementById('mapsDataSel').value='6'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
                            <br><button style="border-radius: 3px; font-size: small; cursor: cell;" title="Map 7" onclick="document.getElementById('mapsDataSel').value='7'; document.getElementById('mapsDataSel').dispatchEvent(new Event('change'))"><img src="https://cacsofwi.org/wp-content/uploads/2025/07/cacsofwi-logo-250x75px.png" style="width: 250px; height: 75px;"></img></button>
