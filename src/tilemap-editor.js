...
<!--                <button id="removeTileAnimBtn" title="remove animation">-</button>-->
      ...
      <div style="border-radius: 6px;" id="mapholder" class="tileset-container">
        ...
        <canvas onclick="new Audio('https://bellblitzking.github.io/Map-Maker-RPG-Level-Builder/GenericClick_1.wav').play()" style="border-radius: 6px;" id="tilesetCanvas" />
        ...
        <div style="cursor: default;" class="canvas_wrapper" id="canvas_wrapper">
          <canvas onclick="new Audio('https://bellblitzking.github.io/Map-Maker-RPG-Level-Builder/GenericClick_2.wav').play()" id="mapCanvas" width="${width}" height="${height}"></canvas>
