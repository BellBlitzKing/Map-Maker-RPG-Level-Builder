 ...
 <!-- Tab links added -->
                        ...
                        <div class="tab-container">
                          <div style="background: linear-gradient(to bottom, #28423a 94%, aliceblue 94%);" class="tabs">
							...
							onclick="document.getElementById('mapholder').style.display = 'table' ; document.getElementById('tileGroupButtons').style.display = 'block' ; document.getElementById('card_left_column_alt').scrollTo({ left: 0, top: this.value});"
							...
							onclick="document.getElementById('mapholder').style.display = 'none';" onclick="document.getElementById('tileGroupButtons').style.display = 'none' ; document.getElementById('tileGroupButtons').style.display = 'none' ; document.getElementById('myTiles').value = document.getElementById('card_left_column_alt').scrollTop ;" 
