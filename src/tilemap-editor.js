...
<!--                <button id="removeTileAnimBtn" title="remove animation">-</button>-->
      ...
      <div style="border-radius: 6px;" id="mapholder" class="tileset-container">
        ...
        <canvas onclick="new Audio('https://bellblitzking.github.io/Map-Maker-RPG-Level-Builder/SFX_FastUiClickDoubleClick01.wav').play()" style="border-radius: 6px;" id="tilesetCanvas" />
